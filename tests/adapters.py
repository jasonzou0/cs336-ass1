...
def run_rope(
    ...
    """
    layer_rope=RoPE(d_k=d_k, theta=theta, max_seq_len=max_seq_len, device=in_query_or_key.device, dtype=in_query_or_key.dtype)
    return layer_rope(in_query_or_key)
    # raise NotImplementedError
